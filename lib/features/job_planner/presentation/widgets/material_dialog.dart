  ...
  return await showDialog<Map<String, dynamic>?>(
    ...
    builder: (ctx) => StatefulBuilder(
        builder: (ctx2, setStateOuter) => Consumer(builder: (c, ref, _) {
              final allFertsAsync =
                  ref.watch(fert_provs.fertilizersListProvider);
                ...
                actions: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        ...
                        try {
                          final controller =
                              ref.read(fert_provs.fertilizerControllerProvider);
                          showDialog(
                              context: ctx,
                          ...
                          final created =
                              await controller.createMix(localPayload);
                          ...
                          final result = {
                            ...
                            'fertilizers': (created['fertilizers'] as List?)
                                    ?.map((e) =>
